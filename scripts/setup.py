...
def main():
    ...
    # Local images can freely choose the target stage to build
    ...
    # but can be freely overridden by the user. E.g verifying a patch against a production image
    compose_file = get_value('COMPOSE_FILE', (
        'docker-compose.yml' if is_production else
