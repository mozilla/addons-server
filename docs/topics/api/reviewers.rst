...
.. http:get:: /api/v4/reviewers/addon/(int:addon_id)/versions/(int:version_id)/draft_comments/(int:comment_id)/
    ...
    :>json string|null filename: The absolute file path a specific comment is related to. Can be ``null`` in case a comment doesn't belong to a specific file but the whole version.
...
.. http:post:: /api/v4/reviewers/addon/(int:addon_id)/versions/(int:version_id)/draft_comments/
    ...
    :<json string filename: The absolute file path this comment is related to (optional). This must represent the absolute path, including sub-folders.
...
.. http:patch:: /api/v4/reviewers/addon/(int:addon_id)/versions/(int:version_id)/draft_comments/(int:comment_id)
    ...
    :<json string comment: The comment that is being drafted as part of a review.
    :<json string filename: The absolute file path this comment is related to. This must represent the absolute path, including sub-folders.
