...
.. http:get:: /api/v4/hero/primary/
    ...
    :>json string results[].gradient.start: The starting color name for gradient - typically top or left. The names are the photon color variables from https://github.com/FirefoxUX/photon-colors/blob/master/photon-colors.scss
    :>json string results[].gradient.end: The ending color name for gradient - typically bottom or right. The names are the photon color variables from https://github.com/FirefoxUX/photon-colors/blob/master/photon-colors.scss
