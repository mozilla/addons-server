...
- **[docker-compose.development.yml][docker-compose-development]**: Overrides certain configurations for local development needs, ensuring the environment is optimized for development.
