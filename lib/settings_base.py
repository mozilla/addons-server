...
MINIFY_BUNDLES = {
    'css': {
        ...
        'zamboni/css': (
            ...
            'css/impala/formset.styl',
            'css/impala/suggestions.styl',
            'css/impala/header.styl',
            'css/impala/moz-tab.css',
            'css/impala/footer.styl',
            'css/impala/faux-zamboni.styl',
            'css/impala/collection-stats.styl',
            'css/zamboni/themes.styl',
        ),
        'zamboni/impala': (
            'css/impala/base.css',
            'css/legacy/jquery-lightbox.css',
            'css/impala/site.styl',
            'css/impala/typography.styl',
            'css/global/headerfooter.css',
            'css/impala/forms.styl',
            'css/common/invisible-upload.styl',
            'css/impala/header.styl',
            'css/impala/footer.styl',
            'css/impala/moz-tab.css',
            'css/impala/hovercards.styl',
            'css/impala/toplist.styl',
            'css/impala/carousel.styl',
            'css/impala/reviews.styl',
            'css/impala/buttons.styl',
            'css/impala/promos.styl',
            'css/impala/addon_details.styl',
            'css/impala/policy.styl',
            'css/impala/expando.styl',
            'css/impala/popups.styl',
            'css/impala/l10n.styl',
            'css/impala/contributions.styl',
            'css/impala/lightbox.styl',
            'css/impala/prose.styl',
            'css/impala/sharing.styl',
            'css/impala/abuse.styl',
            'css/impala/paginator.styl',
            'css/impala/listing.styl',
            'css/impala/versions.styl',
            'css/impala/users.styl',
            'css/impala/collections.styl',
            'css/impala/tooltips.styl',
            'css/impala/search.styl',
            'css/impala/suggestions.styl',
            'css/impala/colorpicker.styl',
            'css/impala/personas.styl',
            'css/impala/login.styl',
            'css/impala/dictionaries.styl',
            'css/impala/apps.styl',
            'css/impala/formset.styl',
            'css/impala/tables.styl',
            'css/impala/compat.styl',
            'css/impala/localizers.styl',
        ),
        'zamboni/stats': (
            'css/impala/stats.styl',
        ),
        ...
        'zamboni/devhub': (
            ...
            'css/zamboni/docs.styl',
            'css/impala/developers.styl',
            'css/impala/personas.styl',
            'css/devhub/packager.styl',
            'css/devhub/listing.styl',
            'css/devhub/popups.styl',
            'css/devhub/compat.styl',
            'css/impala/formset.styl',
            'css/devhub/forms.styl',
            'css/common/invisible-upload.styl',
            'css/devhub/submission.styl',
            'css/devhub/refunds.styl',
            'css/devhub/buttons.styl',
            'css/devhub/in-app-config.styl',
        ),
        'zamboni/devhub_impala': (
            ...
            'css/devhub/popups.styl',
            'css/devhub/compat.styl',
            'css/devhub/dashboard.styl',
            'css/devhub/forms.styl',
            'css/common/invisible-upload.styl',
            'css/devhub/submission.styl',
            'css/devhub/search.styl',
            'css/devhub/refunds.styl',
        ),
        'zamboni/editors': (
        ...
        'zamboni/mobile': (
            ...
            'css/mobile/typography.styl',
            'css/mobile/forms.styl',
            'css/mobile/header.styl',
            'css/mobile/search.styl',
            'css/mobile/listing.styl',
            'css/mobile/footer.styl',
        ),
        'zamboni/admin': (
