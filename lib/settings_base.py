...
COMPAT = (
    # Firefox.
    dict(app=1, main='17.0', versions=('17.0', '17.0a2', '17.0a1'),
         previous='16.0'),
    dict(app=1, main='16.0', versions=('16.0', '16.0a2', '16.0a1'),
         previous='15.0'),
    ...
    dict(app=1, main='4.0', versions=('4.0', '4.0a1', '3.7a'),
         previous='3.6'),
    # Thunderbird.
    dict(app=18, main='17.0', versions=('17.0', '17.0a2', '17.0a1'),
         previous='16.0'),
    dict(app=18, main='16.0', versions=('16.0', '16.0a2', '16.0a1'),
         previous='15.0'),
