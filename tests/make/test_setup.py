...
class TestGetDockerTag(BaseTestClass):
    ...
    @override_env(DOCKER_VERSION='test', DOCKER_COMMIT='commit', DOCKER_BUILD='build')
    ...
    @override_env(
        DOCKER_DIGEST='sha256:123', DOCKER_COMMIT='commit', DOCKER_BUILD='build'
    )
    ...
    @override_env(
        DOCKER_TAG='image:latest', DOCKER_COMMIT='commit', DOCKER_BUILD='build'
    )
    ...
    @override_env(
        DOCKER_TAG='image@sha256:123', DOCKER_COMMIT='commit', DOCKER_BUILD='build'
    )
