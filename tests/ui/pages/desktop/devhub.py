...
class DevHub(Base):
    ...
    _continue_sub_btn_locator = (By.CSS_SELECTOR,
                                 '.addon-submission-field > button:nth-child(1)')
    _override_validation_locator = (By.CSS_SELECTOR, 'input#id_admin_override_validation')
    _submit_addon_btn_locator = (By.CSS_SELECTOR,
    ...
    class Header(Region):
        ...
        _sign_in_locator = (By.CSS_SELECTOR,
