...
class DevhubSubmission(Base):
    ...
    _bookmarks_categgories_locator = (By.ID, 'id_form-0-categories_1')
    _edit_submission_btn_locator = (By.CSS_SELECTOR,
    ...
    def fill_addon_submission_form(self):
        ...
        self.find_element(*self._bookmarks_categgories_locator).click()
