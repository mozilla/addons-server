define('suggestions', [], function() {
    function init($results, searchType) {
        // Blur handler for search suggestions
        ...
        var delayDismissHandler = function() {
        ...
        return {
            ...
            delayDismissHandler: delayDismissHandler
        };
    }
    return init;
});
...
$.fn.searchSuggestions = function($results, processCallback, searchType) {
    ...
    var suggestions = require('suggestions')($results, searchType);
    var dismissHandler = suggestions.dismissHandler;
    var delayDismissHandler = suggestions.delayDismissHandler;
    ...
    }).delegate('a:not(.no-blur)', 'click', function() {
