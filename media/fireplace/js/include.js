...
["url", "type", "id"], 
[], 
function (l_url, l_type, l_id, kwargs) {
frame = frame.push();
kwargs = kwargs || {};
frame.set("url", l_url);
...
output += runtime.suppressValue((lineno = 6, colno = 21, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "potato_captcha"), "potato_captcha", [])), env.autoesc);
output += "\n      <input type=\"hidden\" name=\"";
output += runtime.suppressValue(l_type, env.autoesc);
output += "\" value=\"";
output += runtime.suppressValue(l_id, env.autoesc);
output += "\">\n      <button type=\"submit\">";
output += runtime.suppressValue((lineno = 8, colno = 30, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Send Report"])), env.autoesc);
output += "</button>\n    </p>\n  </form>\n";
frame = frame.pop();
return new runtime.SafeString(output);
});
context.addExport("abuse_form");
context.setVariable("abuse_form", macro_t_1);
output += "\n\n";
...
context.setVariable("potato_captcha", macro_t_2);
output += "\n";
return output;
} catch (e) {
  runtime.handleError(e, lineno, colno);
...
output += runtime.suppressValue((runtime.memberLookup((l_app),"price", env.autoesc)?runtime.memberLookup((l_app),"price", env.autoesc):(lineno = 16, colno = 61, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Free"]))), env.autoesc);
...
if(!runtime.contextOrFrameLookup(context, frame, "link")) {
output += "\n          <a href=\"";
output += runtime.suppressValue((lineno = 19, colno = 23, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["app/ratings",[runtime.memberLookup((l_app),"slug", env.autoesc)]])), env.autoesc);
...
output += runtime.suppressValue((lineno = 6, colno = 10, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "stars"), "stars", [runtime.memberLookup((l_this),"rating", env.autoesc),runtime.makeKeywordArgs({"detailpage": runtime.contextOrFrameLookup(context, frame, "detailpage")})])), env.autoesc);
output += "\n    <span class=\"byline\">\n      ";
output += runtime.suppressValue((lineno = 8, colno = 8, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["by <strong>{author}</strong>",runtime.makeKeywordArgs({"author": (lineno = 8, colno = 54, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "escape"), "escape", [runtime.memberLookup((runtime.memberLookup((l_this),"user", env.autoesc)),"display_name", env.autoesc)]))})])), env.autoesc);
output += "\n      ";
...
output += "\n        ";
output += runtime.suppressValue((lineno = 10, colno = 10, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["for previous version {version}",runtime.makeKeywordArgs({"version": runtime.memberLookup((runtime.memberLookup((l_this),"version", env.autoesc)),"name", env.autoesc)})])), env.autoesc);
output += "\n      ";
}
output += "\n    </span>\n    <div class=\"body\">\n      ";
...
output += "\n          <li class=\"flagged\">";
output += runtime.suppressValue((lineno = 19, colno = 32, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Flagged for review"])), env.autoesc);
output += "</li>\n        ";
}
output += "\n        ";
...
output += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "title"), env.autoesc);
output += "\">\n    ";
output += runtime.suppressValue((lineno = 3, colno = 6, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Rated {stars} out of 5 stars",runtime.makeKeywordArgs({"stars": t_2})])), env.autoesc);
output += "\n  </span>\n";
frame = frame.pop();
return new runtime.SafeString(output);
});
...
output += "\n\n";
output += runtime.suppressValue(env.getExtension("defer")["run"](context,runtime.makeKeywordArgs({"url": runtime.contextOrFrameLookup(context, frame, "endpoint"),"pluck": "featured","as": "app"}),function() {var t_8 = "";t_8 += "\n  <section id=\"featured\" class=\"main category featured full c\">\n    <header class=\"featured-header c\">\n      <h3>";
...
t_14 += "\n  <section id=\"gallery\" class=\"main category gallery";
t_14 += runtime.suppressValue((!t_15?" nonpaginated":""), env.autoesc);
t_14 += " full c\">\n    ";
if(t_15) {
t_14 += "\n      <header class=\"featured-header c\">\n        <nav class=\"tabs\">\n          <a";
...
t_14 += "\">";
t_14 += runtime.suppressValue((lineno = 38, colno = 71, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Popular"])), env.autoesc);
t_14 += "</a>\n          <a";
...
t_14 += "\">";
t_14 += runtime.suppressValue((lineno = 39, colno = 76, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["New"])), env.autoesc);
t_14 += "</a>\n        </nav>\n        <a href=\"";
t_14 += runtime.suppressValue(t_7, env.autoesc);
t_14 += "\" class=\"view-all\">";
t_14 += runtime.suppressValue((lineno = 41, colno = 50, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["View All"])), env.autoesc);
t_14 += "</a>\n      </header>\n    ";
}
...
t_14 += runtime.suppressValue((lineno = 47, colno = 22, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "market_tile"), "market_tile", [t_18,runtime.makeKeywordArgs({"link": true,"force_button": true,"src": runtime.contextOrFrameLookup(context, frame, "sort")})])), env.autoesc);
t_14 += "\n        </li>\n      ";
}
frame = frame.pop();
t_14 += "\n\n      ";
...
t_14 += "\n        ";
t_14 += runtime.suppressValue((lineno = 53, colno = 20, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "more_button"), "more_button", [runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "response")),"meta", env.autoesc)),"next", env.autoesc)])), env.autoesc);
t_14 += "\n      ";
}
t_14 += "\n    </ol>\n  </section>\n";
return t_14;
...
t_20 += runtime.suppressValue((lineno = 61, colno = 6, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["No apps in this category"])), env.autoesc);
t_20 += "\n  </p>\n";
return t_20;
}
,function() {var t_21 = "";t_21 += "\n  <p class=\"no-results\">\n    ";
t_21 += "\n    ";
t_21 += runtime.suppressValue((lineno = 66, colno = 6, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["No apps in this category, try again later"])), env.autoesc);
t_21 += "\n  </p>\n";
return t_21;
}
), env.autoesc);
...
output += "</h1>\n    ";
output += runtime.suppressValue((lineno = 5, colno = 15, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "abuse_form"), "abuse_form", [(lineno = 5, colno = 19, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "api"), "api", ["app_abuse"])),"app",runtime.contextOrFrameLookup(context, frame, "slug")])), env.autoesc);
output += "\n  </div>\n</div>\n";
return output;
} catch (e) {
  runtime.handleError(e, lineno, colno);
...
output += "\n\n<div class=\"detail\">\n<section class=\"main product-details listing verbose expanded c\">\n  ";
...
output += runtime.suppressValue((lineno = 28, colno = 8, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Installed!"])), env.autoesc);
output += "\n    </p>\n    <p class=\"how mac\">\n      ";
output += runtime.suppressValue((lineno = 31, colno = 8, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Launch this app from your <b>Applications</b> directory."])), env.autoesc);
output += "\n    </p>\n    <p class=\"how windows\">\n      ";
output += runtime.suppressValue((lineno = 34, colno = 8, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Launch this app from your <b>Windows desktop</b> or <b>Start &#9658; All Programs</b>."])), env.autoesc);
output += "\n    </p>\n    <p class=\"how linux\">\n      ";
output += runtime.suppressValue((lineno = 37, colno = 8, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Launch this app from your <b>dash</b>, <b>Application picker</b>, or <b>Applications menu</b>."])), env.autoesc);
output += "\n    </p>\n  </div>\n</section>\n<div id=\"purchased-message\"></div>\n\n<section class=\"main blurbs infobox\">\n  <div>\n    ";
output += runtime.suppressValue(env.getExtension("defer")["run"](context,runtime.makeKeywordArgs({"url": t_1,"as": "app","key": runtime.contextOrFrameLookup(context, frame, "slug")}),function() {var t_4 = "";t_4 += "\n      ";
var t_5 = runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"summary", env.autoesc)),"length", env.autoesc) + runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "description")),"length", env.autoesc) > 700;
frame.set("super_long", t_5);
if(!frame.parent) {
context.setVariable("super_long", t_5);
context.addExport("super_long");
}
t_4 += "\n      <p class=\"summary\">\n        ";
t_4 += runtime.suppressValue(env.getFilter("nl2br")(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"summary", env.autoesc)), env.autoesc);
t_4 += "\n        ";
if(t_5) {
t_4 += "\n          <a href=\"#\" class=\"show-toggle\" data-toggle-text=\"";
t_4 += runtime.suppressValue((lineno = 50, colno = 62, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Less&hellip;"])), env.autoesc);
t_4 += "\">";
t_4 += runtime.suppressValue((lineno = 50, colno = 83, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["More&hellip;"])), env.autoesc);
t_4 += "</a>\n        ";
}
t_4 += "\n      </p>\n\n      ";
...
t_4 += "\n            <h3>";
t_4 += runtime.suppressValue((lineno = 57, colno = 18, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Description"])), env.autoesc);
t_4 += "</h3>\n            <div class=\"description\">";
t_4 += runtime.suppressValue(env.getFilter("nl2br")(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"description", env.autoesc)), env.autoesc);
t_4 += "</div>\n          ";
}
t_4 += "\n          ";
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"is_packaged", env.autoesc)) {
t_4 += "\n            <h3>";
t_4 += runtime.suppressValue((lineno = 61, colno = 18, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Version"])), env.autoesc);
t_4 += "</h3>\n            <div class=\"package-version\">\n              ";
t_4 += runtime.suppressValue((lineno = 63, colno = 16, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Latest version: {version}",runtime.makeKeywordArgs({"version": runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"current_version", env.autoesc)})])), env.autoesc);
t_4 += "\n            </div>\n            <div class=\"release-notes\">\n              ";
t_4 += runtime.suppressValue(env.getFilter("nl2br")(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"current_version", env.autoesc)),"releasenotes", env.autoesc)), env.autoesc);
t_4 += "\n            </div>\n          ";
}
t_4 += "\n        </div>\n      ";
}
...
output += runtime.suppressValue(env.getExtension("defer")["run"](context,runtime.makeKeywordArgs({"url": (lineno = 80, colno = 25, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "apiParams"), "apiParams", ["reviews",{"app": runtime.contextOrFrameLookup(context, frame, "slug")}])),"id": "ratings"}),function() {var t_7 = "";t_7 += "\n      <h3>";
t_7 += runtime.suppressValue((lineno = 81, colno = 12, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Reviews"])), env.autoesc);
t_7 += "</h3>\n      ";
...
frame = frame.push();
var t_9 = (lineno = 84, colno = 40, runtime.callWrap(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"objects", env.autoesc)),"slice", env.autoesc), "this[\"objects\"][\"slice\"]", [0,2]));
for(var t_8=0; t_8 < t_9.length; t_8++) {
var t_10 = t_9[t_8];
frame.set("rat", t_10);
t_7 += "\n            ";
t_7 += runtime.suppressValue((lineno = 85, colno = 19, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "rating"), "rating", [t_10,runtime.makeKeywordArgs({"detailpage": true})])), env.autoesc);
t_7 += "\n          ";
}
frame = frame.pop();
t_7 += "\n        </ul>\n        <div class=\"";
...
t_7 += "\">\n            <span>\n              ";
t_7 += runtime.suppressValue((lineno = 91, colno = 22, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_plural"), "_plural", ["{n} Review","{n} Reviews",runtime.makeKeywordArgs({"n": runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"meta", env.autoesc)),"total_count", env.autoesc)})])), env.autoesc);
t_7 += "\n            </span>\n            ";
t_7 += runtime.suppressValue((lineno = 94, colno = 18, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "stars"), "stars", [runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"info", env.autoesc)),"average", env.autoesc),runtime.makeKeywordArgs({"detailpage": true})])), env.autoesc);
t_7 += "\n          </a>\n        </div>\n      ";
}
else {
t_7 += "\n        <p class=\"not-rated\">\n          ";
t_7 += runtime.suppressValue((lineno = 99, colno = 12, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["App not yet rated"])), env.autoesc);
t_7 += "\n        </p>\n      ";
}
t_7 += "\n      ";
...
t_7 += "\">\n              ";
t_7 += runtime.suppressValue((lineno = 106, colno = 16, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Edit Your Review"])), env.autoesc);
t_7 += "</a>\n          ";
}
else {
...
output += runtime.suppressValue(env.getExtension("defer")["run"](context,runtime.makeKeywordArgs({"url": t_1,"as": "app","key": runtime.contextOrFrameLookup(context, frame, "slug")}),function() {var t_12 = "";t_12 += "\n      <ul class=\"c\">\n        ";
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"support_email", env.autoesc)) {
t_12 += "\n          <li class=\"support-email\">\n            ";
t_12 += runtime.suppressValue((lineno = 128, colno = 22, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "emaillink"), "emaillink", [runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"support_email", env.autoesc),(lineno = 128, colno = 44, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Support Email"])),runtime.makeKeywordArgs({"class": "button alt"})])), env.autoesc);
t_12 += "\n          </li>\n        ";
}
t_12 += "\n        ";
...
t_12 += runtime.suppressValue(env.getFilter("external_href")(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"support_url", env.autoesc)), env.autoesc);
t_12 += ">\n              ";
t_12 += runtime.suppressValue((lineno = 134, colno = 16, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Support Site"])), env.autoesc);
t_12 += "</a>\n          </li>\n        ";
}
t_12 += "\n        ";
if(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"homepage", env.autoesc)) {
t_12 += "\n          <li class=\"homepage\">\n            <a class=\"button alt\" rel=\"external\" ";
t_12 += runtime.suppressValue(env.getFilter("external_href")(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"homepage", env.autoesc)), env.autoesc);
t_12 += ">";
t_12 += runtime.suppressValue((lineno = 139, colno = 81, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Homepage"])), env.autoesc);
t_12 += "</a>\n          </li>\n        ";
}
t_12 += "\n        ";
...
t_12 += runtime.suppressValue((lineno = 143, colno = 46, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["app/privacy",[runtime.contextOrFrameLookup(context, frame, "slug")]])), env.autoesc);
t_12 += "\">\n            ";
t_12 += runtime.suppressValue((lineno = 144, colno = 14, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Privacy Policy"])), env.autoesc);
t_12 += "</a></li>\n        ";
}
t_12 += "\n        ";
...
t_12 += runtime.suppressValue(runtime.contextOrFrameLookup(context, frame, "slug"), env.autoesc);
t_12 += "/\">\n            ";
t_12 += runtime.suppressValue((lineno = 148, colno = 14, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Statistics"])), env.autoesc);
t_12 += "</a></li>\n        ";
}
t_12 += "\n        <li><a class=\"button alt\" href=\"";
t_12 += runtime.suppressValue((lineno = 150, colno = 44, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["app/abuse",[runtime.contextOrFrameLookup(context, frame, "slug")]])), env.autoesc);
t_12 += "\">\n          ";
t_12 += runtime.suppressValue((lineno = 151, colno = 12, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Report Abuse"])), env.autoesc);
t_12 += "</a></li>\n      </ul>\n      ";
...
t_12 += runtime.suppressValue(env.getFilter("urlparams")(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"upsell", env.autoesc)),"url", env.autoesc),runtime.makeKeywordArgs({"src": "mkt-detail-upsell"})), env.autoesc);
t_12 += "\">\n             <span class=\"avail\">";
t_12 += runtime.suppressValue((lineno = 157, colno = 35, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Premium version available"])), env.autoesc);
t_12 += "</span>\n             <img class=\"icon\" src=\"";
t_12 += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "upsell")),"icons", env.autoesc)),16, env.autoesc), env.autoesc);
t_12 += "\">\n             <span class=\"name\">";
t_12 += runtime.suppressValue(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"upsell", env.autoesc)),"name", env.autoesc), env.autoesc);
t_12 += "</span>\n          </a>\n        ";
}
t_12 += "\n      ";
}
...
t_13 += runtime.suppressValue((lineno = 173, colno = 14, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Rating by the <a href=\"{dejus_url}\" title=\"{dejus}\">DEJUS</a>",runtime.makeKeywordArgs({"dejus_url": runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "settings")),"DEJUS_URL", env.autoesc),"dejus": runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "settings")),"DEJUS", env.autoesc)})])), env.autoesc);
t_13 += "\n          </h3>\n          <div class=\"content-ratings\">\n            ";
frame = frame.push();
var t_15 = (lineno = 178, colno = 54, runtime.callWrap(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "this")),"content_ratings", env.autoesc)),"values", env.autoesc), "this[\"content_ra\"][\"values\"]", []));
for(var t_14=0; t_14 < t_15.length; t_14++) {
var t_16 = t_15[t_14];
frame.set("rating", t_16);
t_13 += "\n              <div class=\"content-rating c\">\n                <div class=\"icon icon-";
t_13 += runtime.suppressValue(runtime.memberLookup((t_16),"name", env.autoesc), env.autoesc);
t_13 += "\" title=\"";
t_13 += runtime.suppressValue(runtime.memberLookup((t_16),"name", env.autoesc), env.autoesc);
t_13 += "\">";
t_13 += runtime.suppressValue(runtime.memberLookup((t_16),"name", env.autoesc), env.autoesc);
t_13 += "</div>\n                <p class=\"description\">";
t_13 += runtime.suppressValue(runtime.memberLookup((t_16),"description", env.autoesc), env.autoesc);
t_13 += "</p>\n              </div>\n            ";
}
frame = frame.pop();
t_13 += "\n          </div>\n        </div>\n      </div>\n    ";
...
var output = "";
try {
output += "<div class=\"main privacy-policy infobox c\">\n  <div>\n    <h3>";
...
output += "</h3>\n    ";
output += runtime.suppressValue(env.getExtension("defer")["run"](context,runtime.makeKeywordArgs({"url": (lineno = 3, colno = 19, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "api"), "api", ["app",[runtime.contextOrFrameLookup(context, frame, "slug")]])),"as": "app","key": runtime.contextOrFrameLookup(context, frame, "slug"),"pluck": "privacy_policy"}),function() {var t_1 = "";t_1 += "\n      <p>";
t_1 += runtime.suppressValue(env.getFilter("nl2br")(runtime.contextOrFrameLookup(context, frame, "this")), env.autoesc);
t_1 += "</p>\n\n    ";
return t_1;
}
,function() {var t_2 = "";t_2 += "\n      <p>";
t_2 += runtime.suppressValue((lineno = 7, colno = 11, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Loading privacy policy..."])), env.autoesc);
t_2 += "</p>\n    ";
return t_2;
}
,null,null), env.autoesc);
...
t_1 += "\"></a>\n    </header>\n    <ol class=\"container listing search-listing verbose c\">\n      ";
frame = frame.push();
...
output += "\"\n         ";
if(runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "z")),"context", env.autoesc)),"search", env.autoesc)) {
output += "data-context";
}
output += ">\n    <a href=\"#\" class=\"search-clear\" title=\"";
output += runtime.suppressValue((lineno = 11, colno = 46, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Clear"])), env.autoesc);
output += "\">";
output += runtime.suppressValue((lineno = 11, colno = 60, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Clear"])), env.autoesc);
output += "</a>\n  </form>\n  <span class=\"flex-span\"></span>\n  <div class=\"act-tray\">\n    <a href=\"";
output += runtime.suppressValue((lineno = 15, colno = 17, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["settings"])), env.autoesc);
output += "\" class=\"header-button icon settings\" title=\"";
output += runtime.suppressValue((lineno = 15, colno = 77, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Settings"])), env.autoesc);
output += "\"></a>\n    <div class=\"account-links only-logged-in\">\n      <ul>\n        <li>\n          <a href=\"";
output += runtime.suppressValue((lineno = 19, colno = 23, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["settings"])), env.autoesc);
output += "\">\n            <b>";
output += runtime.suppressValue((lineno = 20, colno = 32, runtime.callWrap(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "user")),"get_setting", env.autoesc), "user[\"get_settin\"]", ["email"])), env.autoesc);
output += "</b>\n            ";
output += runtime.suppressValue((lineno = 21, colno = 14, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Edit Account Settings"])), env.autoesc);
output += "</a>\n        </li>\n        <li><a href=\"";
output += runtime.suppressValue((lineno = 23, colno = 25, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["purchases"])), env.autoesc);
output += "\">";
output += runtime.suppressValue((lineno = 23, colno = 43, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["My Apps"])), env.autoesc);
output += "</a></li>\n        <li><a class=\"submit-feedback\" href=\"#\">";
output += runtime.suppressValue((lineno = 24, colno = 50, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Feedback"])), env.autoesc);
output += "</a></li>\n        <li><a href=\"#\" class=\"logout\">";
output += runtime.suppressValue((lineno = 25, colno = 41, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Sign Out"])), env.autoesc);
output += "</a></li>\n      </ul>\n    </div>\n  </div>\n  <a href=\"#\" class=\"header-button persona\">";
output += runtime.suppressValue((lineno = 29, colno = 46, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Sign In"])), env.autoesc);
output += "</a>\n</nav>\n";
return output;
} catch (e) {
  runtime.handleError(e, lineno, colno);
...
var output = "";
try {
output += "<div class=\"main terms-of-use infobox c\">\n  <section id=\"terms-of-use\" class=\"main primary prose\">\n    <div class=\"container prose\">\n    <h1>";
output += runtime.suppressValue((lineno = 3, colno = 10, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Terms of Use"])), env.autoesc);
...
output += runtime.suppressValue((lineno = 12, colno = 75, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["privacy"])), env.autoesc);
...
output += runtime.suppressValue((lineno = 56, colno = 486, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["privacy"])), env.autoesc);
...
output += runtime.suppressValue((lineno = 57, colno = 195, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["privacy"])), env.autoesc);
output += "\">Privacy Policy</a> for more detail.</p>\n    <p>While the Firefox Marketplace <a href=\"";
output += runtime.suppressValue((lineno = 58, colno = 50, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "url"), "url", ["site.privacy"])), env.autoesc);
...
templates["user/abuse.html"] = (function() {function root(env, context, frame, runtime) {
var lineno = null;
var colno = null;
var output = "";
try {
...
output += runtime.suppressValue((lineno = 4, colno = 10, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["Report Abuse"])), env.autoesc);
output += "</h3>\n    <p>";
output += runtime.suppressValue((lineno = 5, colno = 9, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "_"), "_", ["If you suspect this user violates <a href=\"{url}\">our policies</a>,\n             please use the form below to describe your concerns. Please do not\n             use this form for any other reason.",runtime.makeKeywordArgs({"url": "https://developer.mozilla.org/en-US/docs/Apps/Marketplace_Review"})])), env.autoesc);
output += "</p>\n    ";
output += runtime.suppressValue((lineno = 9, colno = 15, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "abuse_form"), "abuse_form", [(lineno = 9, colno = 19, runtime.callWrap(runtime.contextOrFrameLookup(context, frame, "api"), "api", ["user_abuse"])),"user",runtime.contextOrFrameLookup(context, frame, "id")])), env.autoesc);
output += "\n  </div>\n</div>\n";
return output;
} catch (e) {
  runtime.handleError(e, lineno, colno);
