...
def select_request_fingerprint_headers(headers):
    """Get request metadata from request.headers."""
    return {
        'ja4': headers.get('Client-JA4'),
        'sigsci_tags': headers.get('X-SigSci-Tags'),
    }
