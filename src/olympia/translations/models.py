...
class Translation(ModelBase):
    ...
    class Meta:
        ...
        constraints = (models.UniqueConstraint(fields=('id', 'locale'), name='id'),)
...
class PureTranslation(Translation):
    ...
    allowed_tags = ()
    allowed_attributes = {}  # noqa: RUF012 (in py315 update to frozendict)
            ...
            transforms=(
                ...
                Sanitize(
                    policy=self.get_sanitization_policy(
                        ...
                        # Drop any disallowed converted Markdown so
                        # the user is not shown escaped HTML.
                        tag_handling='drop',
                    ),
                ),
            )
