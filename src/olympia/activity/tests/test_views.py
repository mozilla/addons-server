...
class TestReviewNotesViewSetDetail(ReviewNotesViewSetDetailMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.note = self.log(u'noôo!', amo.LOG.REQUEST_INFORMATION, self.days_ago(0))
...
class TestReviewNotesViewSetList(ReviewNotesViewSetDetailMixin, TestCase):
    ...
    def setUp(self):
        ...
        self.user = user_factory()
        self.note = self.log(u'noôo!', amo.LOG.APPROVE_VERSION, self.days_ago(2))
        self.note2 = self.log(
            u'réply!', amo.LOG.DEVELOPER_REPLY_VERSION, self.days_ago(1)
        )
        self.note3 = self.log(
            u'yéss!', amo.LOG.REVIEWER_REPLY_VERSION, self.days_ago(0)
        )
