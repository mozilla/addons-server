...
class TestLogAndNotify(TestCase):
    def setUp(self):
        ...
        self.grant_permission(
            self.reviewer, 'Addons:Review', 'Addon Reviewers'
        )
    ...
    def test_staff_cc_group_is_empty_no_failure(self):
        ...
        log_and_notify(
            amo.LOG.REJECT_VERSION, u'á', self.reviewer, self.version
        )
    ...
    def test_review_url_unlisted(self, send_mail_mock):
        ...
        self.grant_permission(
            self.reviewer, 'Addons:ReviewUnlisted', 'Addon Reviewers'
        )
