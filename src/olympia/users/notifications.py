...
REMOTE_NOTIFICATIONS_BY_ID = {l.id: l for l in REMOTE_NOTIFICATIONS}
...
NOTIFICATIONS_CHOICES = [(l.id, l.label) for l in NOTIFICATIONS_COMBINED]
NOTIFICATIONS_CHOICES_NOT_DEV = [
    (l.id, l.label) for l in NOTIFICATIONS_COMBINED if l.group != 'dev']
