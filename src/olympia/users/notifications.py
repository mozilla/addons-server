...
Notification = namedtuple(
    'Notification', ('id', 'group', 'short', 'label', 'mandatory', 'default_checked')
)
...
NOTIFICATIONS_BY_ID = {ntfn.id: ntfn for ntfn in NOTIFICATIONS_COMBINED}
...
NOTIFICATIONS_BY_SHORT = {ntfn.short: ntfn for ntfn in NOTIFICATIONS_COMBINED}
