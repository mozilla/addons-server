...
discopane_items = {
    'default': [
        ...
        DiscoItem(addon_id=677612, type=amo.ADDON_PERSONA),
        # Forget Me Not
        DiscoItem(
            addon_id=884014,
            heading=_(
                u'Leave a clean digital trail {start_sub_heading}'
                u'with {addon_name}{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'Make Firefox forget website data like cookies and local '
        ...
        DiscoItem(
            addon_id=700308,
            heading=_(
                u'Improve videos {start_sub_heading}with '
                u'{addon_name} {end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'Enjoy a suite of new YouTube features, like cinema mode, '
        ...
        DiscoItem(
            addon_id=607454,
            heading=_(
                u'Block ads {start_sub_heading}'
                u'with {addon_name}{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'A lightweight and effective ad blocker. uBlock Origin '
        ...
        DiscoItem(
            addon_id=511962,
            heading=_(
                u'Up your emoji game {start_sub_heading}'
                u'with {addon_name}{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'Dozens of amazing emojis for every occasion—just a click '
                    u'away.'
                ),
                '</blockquote>',
            ),
        ...
        DiscoItem(addon_id=297738, type=amo.ADDON_PERSONA),
    ],
    ...
    'china': [
        ...
        DiscoItem(
            addon_id=3006,
            heading=_(
                u'Download videos {start_sub_heading}with {addon_name}'
                u'{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
        ...
        DiscoItem(
            ...
            heading=_(
                u'Tab Customization {start_sub_heading}with {addon_name}'
                u'{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
        ...
        DiscoItem(addon_id=25725, type=amo.ADDON_PERSONA),
        # Emoji Cheatsheet
        DiscoItem(
            addon_id=511962,
            heading=_(
                u'Enhance your emoji game {start_sub_heading}with '
                u'{addon_name}{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'Dozens of amazing emojis for every occasion—always just '
                    u'one click away.'
                ),
                '</blockquote>',
            ),
        ...
        DiscoItem(
            ...
            heading=_(
                u'Take screenshots {start_sub_heading}with {addon_name}'
                u'{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'More than just a basic screenshot tool, Awesome '
        ...
        # 'Evil Robots' theme.
        DiscoItem(addon_id=153659, type=amo.ADDON_PERSONA),
    ],
}
