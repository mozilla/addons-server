...
detail_patterns = [
    ...
    url(r'^versions/delete$', views.version_delete, name='devhub.versions.delete'),
    url(
        r'^versions/reenable$', views.version_reenable, name='devhub.versions.reenable'
    ),
    url(r'^versions/stats$', views.version_stats, name='devhub.versions.stats'),
    url(
    ...
    url(r'^versions/submit/$', views.submit_version_auto, name='devhub.submit.version'),
    url(
    ...
    url(r'^submit/$', lambda r, addon_id: redirect('devhub.submit.finish', addon_id)),
    url(r'^submit/source$', views.submit_addon_source, name='devhub.submit.source'),
    url(r'^submit/details$', views.submit_addon_details, name='devhub.submit.details'),
    url(r'^submit/finish$', views.submit_addon_finish, name='devhub.submit.finish'),
    url(r'^request-review$', views.request_review, name='devhub.request-review'),
...
urlpatterns = decorate(
    ...
    [
        ...
        url(r'^addon/validate/?$', views.validate_addon, name='devhub.validate_addon'),
        # Redirect to /addons/ at the base.
        url(r'^addon$', lambda r: redirect('devhub.addons', permanent=True)),
        url(r'^addons$', views.dashboard, name='devhub.addons'),
        url(r'^themes$', views.dashboard, name='devhub.themes', kwargs={'theme': True}),
