...
theme_detail_patterns = [
    ...
    url(
        '^edit/upload/' '(?P<upload_type>persona_header)$',
        views.ajax_upload_image,
        name='devhub.personas.reupload_persona',
    ),
...
detail_patterns = [
    ...
    url(
        '^$',
        lambda r, addon_id: redirect(
            'devhub.addons.edit', addon_id, permanent=True
        ),
    ),
    ...
    url(
        '^upload-(?P<channel>listed|unlisted)$',
    ...
    url(
        '^versions/reenable$',
        views.version_reenable,
        name='devhub.versions.reenable',
    ),
    url('^versions/stats$', views.version_stats, name='devhub.versions.stats'),
    url(
        '^versions/(?P<version_id>\d+)$',
        views.version_edit,
    ...
    url(
        '^submit/details$',
        views.submit_addon_details,
        name='devhub.submit.details',
    ),
    url(
        '^submit/finish$',
        views.submit_addon_finish,
        name='devhub.submit.finish',
    ),
    url(
        '^request-review$', views.request_review, name='devhub.request-review'
    ),
...
urlpatterns = decorate(
    ...
    [
        ...
        url(
            '^feed/all$', lambda r: redirect('devhub.feed_all', permanent=True)
        ),
        ...
        # Themes submission.
        url(
            '^theme/submit/?$', views.submit_theme, name='devhub.themes.submit'
        ),
        url(
            '^theme/%s/submit/done$' % ADDON_ID,
            views.submit_theme_done,
            name='devhub.themes.submit.done',
        ),
        url(
            '^theme/submit/upload/' '(?P<upload_type>persona_header)$',
            views.ajax_upload_image,
