...
detail_patterns = [
    ...
    re_path(r'^$', lambda r, addon_id: redirect('devhub.addons.edit', addon_id,
                                            permanent=True)),
...
urlpatterns = decorate(use_primary_db, [
    ...
    # Add-on submission
    re_path(r'^addon/submit/(?:1)?$',
        lambda r: redirect('devhub.submit.agreement', permanent=True)),
    re_path(r'^addon/submit/agreement$', views.submit_addon,
        name='devhub.submit.agreement'),
    re_path(r'^addon/submit/distribution$', views.submit_addon_distribution,
        name='devhub.submit.distribution'),
    re_path(r'^addon/submit/upload-(?P<channel>listed|unlisted)$',
        views.submit_addon_upload, name='devhub.submit.upload'),
    re_path(r'^addon/submit/wizard-(?P<channel>listed|unlisted)$',
        views.submit_addon_theme_wizard, name='devhub.submit.wizard'),

    # Submission API
    re_path(r'^addon/agreement/$', views.api_key_agreement,
        name='devhub.api_key_agreement'),

    re_path(r'^addon/api/key/$', views.api_key, name='devhub.api_key'),

    # Standalone validator:
    re_path(r'^addon/validate/?$', views.validate_addon,
    ...
    re_path(r'^themes$', views.dashboard, name='devhub.themes',
        kwargs={'theme': True}),
    ...
    re_path(r'^theme/submit/?$', lambda r: redirect('devhub.submit.agreement'),
