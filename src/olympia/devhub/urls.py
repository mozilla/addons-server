...
detail_patterns = [
    ...
    re_path(r'^$', lambda r, addon_id: redirect('devhub.addons.edit',
                                                addon_id,
                                                permanent=True)),
    re_path(r'^edit$', views.edit, name='devhub.addons.edit'),
    re_path(r'^delete$', views.delete, name='devhub.addons.delete'),
    re_path(r'^disable$', views.disable,
            name='devhub.addons.disable'),
    ...
    re_path(r'^upload_icon$', views.upload_image,
            {'upload_type': 'icon'},
            name='devhub.addons.upload_icon'),

    re_path(r'^upload-(?P<channel>listed|unlisted)$',
            views.upload_for_version,
            name='devhub.upload_for_version'),
    re_path(r'^upload/(?P<uuid>[^/]+)$',
            views.upload_detail_for_version,
            name='devhub.upload_detail_for_version'),

    re_path(r'^versions$', views.version_list,
            name='devhub.addons.versions'),
    ...
    re_path(r'^file/(?P<file_id>[^/]+)/validation$',
    ...
    re_path(r'^submit/$',
            lambda r, addon_id: redirect('devhub.submit.finish',
                                         addon_id)),
...
redirect_patterns = [
    re_path(r'^addon/edit/(\d+)',
            lambda r, id: redirect('devhub.addons.edit', id,
                                   permanent=True)),
...
urlpatterns = decorate(use_primary_db, [
    ...
    re_path(r'^addon/submit/distribution$',
    ...
    re_path(r'^addon/api/key/$', views.api_key,
            name='devhub.api_key'),
