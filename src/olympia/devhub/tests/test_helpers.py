...
@pytest.mark.parametrize(
    ...
    (
        (LOG.REQUEST_INFORMATION, LOG.REQUEST_INFORMATION, LOG.REQUEST_INFORMATION, 3),
        ...
        # Tests with Approval
        (LOG.APPROVE_VERSION, LOG.REQUEST_INFORMATION, LOG.REQUEST_INFORMATION, 2),
        (LOG.REQUEST_INFORMATION, LOG.APPROVE_VERSION, LOG.REQUEST_INFORMATION, 1),
        (LOG.REQUEST_INFORMATION, LOG.REQUEST_INFORMATION, LOG.APPROVE_VERSION, 0),
        # Tests with Rejection
        (LOG.REJECT_VERSION, LOG.REQUEST_INFORMATION, LOG.REQUEST_INFORMATION, 2),
        (LOG.REQUEST_INFORMATION, LOG.REJECT_VERSION, LOG.REQUEST_INFORMATION, 1),
        (LOG.REQUEST_INFORMATION, LOG.REQUEST_INFORMATION, LOG.REJECT_VERSION, 0),
    ),
)
