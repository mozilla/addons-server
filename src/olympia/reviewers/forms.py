...
class CinderPolicyWidget(forms.CheckboxSelectMultiple):
    ...
    def create_option(
        ...
        actions = (
            ...
            # or if enforcement_actions is `True`, indicating all policies.
            if (eas_from_ra := defn.get('enforcement_actions'))
            and (eas_from_ra is True or actions_on_policy.intersection(eas_from_ra))
        )
