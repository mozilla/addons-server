    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exit_activity_log', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='activity.activitylog')),
                ('version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
