...
urlpatterns = (
    ...
    url(
        r'^queue/new$', views.queue_nominated, name='reviewers.queue_nominated'
    ),
    url(
        r'^queue/updates$', views.queue_pending, name='reviewers.queue_pending'
    ),
    url(
        r'^queue/reviews$',
    ...
    url(
        r'^queue/expired_info_requests',
        views.queue_expired_info_requests,
        name='reviewers.queue_expired_info_requests',
    ),
    url(
        r'^unlisted_queue$',
        views.unlisted_queue,
    ...
    url(
        r'^queue_viewing$', views.queue_viewing, name='reviewers.queue_viewing'
    ),
    url(
        r'^review_viewing$',
        views.review_viewing,
    ...
    url(
        '^themes/queue/$',
        views_themes.themes_queue,
        name='reviewers.themes.queue_themes',
    ),
    url(
        '^themes/queue/flagged$',
        views_themes.themes_queue_flagged,
        name='reviewers.themes.queue_flagged',
    ),
    url(
        '^themes/queue/updates$',
        views_themes.themes_queue_rereview,
        name='reviewers.themes.queue_rereview',
    ),
    url(
        '^themes/queue/commit$',
        views_themes.themes_commit,
        name='reviewers.themes.commit',
    ),
    url(
        '^themes/queue/single/(?P<slug>[^ /]+)$',
        views_themes.themes_single,
        name='reviewers.themes.single',
    ),
    url(
        '^themes/history/(?P<username>[^ /]+)?$',
        views_themes.themes_history,
        name='reviewers.themes.history',
    ),
    url(
        r'^themes/logs$',
        views_themes.themes_logs,
        name='reviewers.themes.logs',
    ),
    url(
        '^themes/release$',
        views_themes.release_locks,
        name='reviewers.themes.release_locks',
    ),
    url(
        '^themes/logs/deleted/$',
        views_themes.deleted_themes,
        name='reviewers.themes.deleted',
    ),
    url(
        '^themes/search/$',
        views_themes.themes_search,
