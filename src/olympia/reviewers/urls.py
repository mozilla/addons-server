...
urlpatterns = (
    ...
    url(r'^queue/extension_new$', views.queue_extension_nominated,
        name='reviewers.queue_extension_nominated'),
    url(r'^queue/extension_updates$', views.queue_extension_pending,
        name='reviewers.queue_extension_pending'),
