...
urlpatterns = (
    ...
    url(r'^queue/extension$', views.queue_extension, name='reviewers.queue_extension'),
    url(
        r'^queue/theme_new$',
    ...
    url(r'^queue/reviews$', views.queue_moderated, name='reviewers.queue_moderated'),
    url(
    ...
    url(
        r'^queue/needs_human_review',
        views.queue_needs_human_review,
    ...
    url(r'^queue_viewing$', views.queue_viewing, name='reviewers.queue_viewing'),
    url(r'^review_viewing$', views.review_viewing, name='reviewers.review_viewing'),
