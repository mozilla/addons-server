...
urlpatterns = (
    ...
    re_path(r'^queue/application_versions\.json$', views.application_versions_json,
    ...
    re_path(r'^moderationlog/(\d+)$', views.ratings_moderation_log_detail,
        name='reviewers.ratings_moderation_log.detail'),
    re_path(r'^reviewlog$', views.reviewlog, name='reviewers.reviewlog'),
    re_path(r'^queue_version_notes/%s?$' % ADDON_ID, views.queue_version_notes,
    ...
    re_path(r'^review(?:-(?P<channel>listed|unlisted|content))?/%s$' % ADDON_ID,
        views.review, name='reviewers.review'),
    re_path(r'^whiteboard/(?P<channel>listed|unlisted|content)/%s$' % ADDON_ID,
    ...
    re_path(r'^download-git-file/(?P<version_id>\d+)/(?P<filename>.*)/',
