...
class TestPrimaryHero(TestCase):
    def test_image_url(self):
        ...
        assert ph.image_url == ('http://testserver/static/img/hero/featured/foo.png')
        ph.update(image='')
    ...
    def test_clean_requires_recommended(self):
        ...
        ph.disco_addon.addon.current_version.update(recommendation_approved=True)
        assert ph.disco_addon.recommended_status == ph.disco_addon.RECOMMENDED
        ph.clean()  # it raises if there's an error
    ...
    def test_clean_only_enabled(self):
        ...
        hero.disco_addon.addon.current_version.update(recommendation_approved=True)
