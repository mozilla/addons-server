...
class TestNew69ThemeProperties(AppVersionsMixin, TestCase):
    ...
    def setUp(self):
        self.call_signing_mock = self.patch('olympia.lib.crypto.signing.call_signing')
    ...
    def test_new_69_theme_properties_from_old(self):
        old = {
            'theme': {
                ...
                'images': {'headerURL': 'path/to/image'},
            }
        }
        ...
        assert new_ == {
            'theme': {
                ...
                'images': {'theme_frame': 'path/to/image'},
            }
        }
    ...
    def test_new_theme_version_with_69_properties(self):
        ...
        addon = addon_factory(type=amo.ADDON_STATICTHEME, version_kw={'version': '1.0'})
