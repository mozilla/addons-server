...
detail_urls = [
    ...
    url(
        '^format:json$',
        views.collection_detail_json,
        name='collections.detail.json',
    ),
    url(
        '^vote/(?P<direction>up|down)$',
        views.collection_vote,
...
urlpatterns = [
    ...
    url(
        '^collections/(?P<username>[^/]+)/$',
        views.user_listing,
        name='collections.user',
    ),
    url(
        '^collections/(?P<username>[^/]+)/(?P<slug>[^/]+)/',
        include(detail_urls),
    ),
    url(
        '^collections/(?P<username>[^/]+)/(?P<slug>[^/]+)/statistics/',
