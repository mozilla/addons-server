...
DJANGO_PERMISSIONS_MAPPING.update(
    {
        ...
        'discovery.add_primaryhero': DISCOVERY_EDIT,
        'discovery.change_primaryhero': DISCOVERY_EDIT,
        'discovery.delete_primaryhero': DISCOVERY_EDIT,
        'discovery.add_promotedaddonpromotion': DISCOVERY_EDIT,
        'discovery.change_promotedaddonpromotion': DISCOVERY_EDIT,
        'discovery.delete_promotedaddonpromotion': DISCOVERY_EDIT,
