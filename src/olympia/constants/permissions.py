...
DJANGO_PERMISSIONS_MAPPING.update(
    {
        ...
        'promoted.add_promotedaddonpromotion': DISCOVERY_EDIT,
        'promoted.change_promotedaddonpromotion': DISCOVERY_EDIT,
        'promoted.delete_promotedaddonpromotion': DISCOVERY_EDIT,
