...
DJANGO_PERMISSIONS_MAPPING.update({
    ...
    'blocklist.add_blsubmission': BLOCKLIST_CREATE,
    'blocklist.change_blsubmission': BLOCKLIST_CREATE,
    'blocklist.signoff_blsubmission': BLOCKLIST_SIGNOFF,
    'blocklist.view_blsubmission': REVIEWS_ADMIN,
