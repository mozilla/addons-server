...
CATEGORIES = {
    FIREFOX.id: {
        ...
        ADDON_DICT: {'general': StaticCategory(id=95, name=_(u'General'))},
        ADDON_SEARCH: {
        ...
        ADDON_LPAPP: {'general': StaticCategory(id=98, name=_(u'General'))},
        ADDON_PERSONA: {
    ...
    THUNDERBIRD.id: {
        ...
        ADDON_DICT: {'general': StaticCategory(id=97, name=_(u'General'))},
        ADDON_LPAPP: {'general': StaticCategory(id=99, name=_(u'General'))},
    },
    SEAMONKEY.id: {
        ADDON_EXTENSION: {
            ...
            'miscellaneous': StaticCategory(id=49, name=_(u'Miscellaneous')),
        ...
        ADDON_DICT: {'general': StaticCategory(id=96, name=_(u'General'))},
        ADDON_LPAPP: {'general': StaticCategory(id=130, name=_(u'General'))},
    },
}
