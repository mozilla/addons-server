...
CATEGORIES = {
    ...
    THUNDERBIRD.id: {
        ADDON_EXTENSION: {
            ...
            'composition': 202,
            'contacts': 23,
            'folders-and-filters': 200,
            'importexport': 206,
            'language-support': 69,
            'message-and-news-reading': 58,
            'privacy-and-security': 66,
            'tags': 212,
        },
        ADDON_THEME: {
            'compact': 64,
    ...
    SEAMONKEY.id: {
        ADDON_EXTENSION: {
            'bookmarks': 51,
            'downloading-and-file-management': 42,
            'interface-customizations': 48,
            'language-support-and-translation': 55,
            'miscellaneous': 49,
            'photos-and-media': 56,
            'privacy-and-security': 46,
            'rss-news-and-blogging': 39,
            'search-tools': 47,
            'site-specific': 52,
            'web-and-developer-tools': 41
        },
        ADDON_THEME: {
            'miscellaneous': 59
        },
