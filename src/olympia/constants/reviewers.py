...
REVIEWED_CHOICES = {
    ...
    REVIEWED_EXTENSION_HIGHEST_RISK: _('Add-on Review (Highest Risk)'),
    REVIEWED_EXTENSION_HIGH_RISK: _('Add-on Review (High Risk)'),
    REVIEWED_EXTENSION_MEDIUM_RISK: _('Add-on Review (Medium Risk)'),
    REVIEWED_EXTENSION_LOW_RISK: _('Add-on Review (Low Risk)'),
}
