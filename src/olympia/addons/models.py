...
class AddonReviewerFlags(ModelBase):
    ...
    auto_approval_disabled_unlisted = models.BooleanField(null=True)
    auto_approval_disabled_until_next_approval = models.BooleanField(null=True)
    auto_approval_delayed_until = models.DateTimeField(default=None, null=True)
    notified_about_auto_approval_delay = models.BooleanField(null=True)
    notified_about_expiring_delayed_rejections = models.BooleanField(null=True)
