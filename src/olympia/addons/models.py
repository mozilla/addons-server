...
class Addon(OnChangeMixin, ModelBase):
    ...
    @staticmethod
    def _attach_authors(
            addons, addon_dict=None, manager='objects', listed=True,
        ...
        addonuser_qs = (addonuser_qs.filter(**filters)
        ...
        [setattr(addon, to_attr, []) for addon in addon_dict.values()
    ...
    def attach_all_authors(addons, addon_dict=None):
        Addon._attach_authors(
            addons, addon_dict=addon_dict, manager='unfiltered', listed=None,
            to_attr='all_authors')
...
class AddonRegionalRestrictions(ModelBase):
    ...
    def clean(self):
        ...
        self.excluded_regions = [
            str(item).upper() for item in self.excluded_regions]
