...
from .views import (
    AddonAutoCompleteSearchView, AddonFeaturedView,
...
sub_addons.register('versions', AddonVersionViewSet,
                    basename='addon-version')
sub_versions = NestedSimpleRouter(sub_addons, r'versions',
                                  lookup='version')
...
urls = [
    ...
    re_path(r'^search/$', AddonSearchView.as_view(),
            name='addon-search'),
