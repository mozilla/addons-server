...
class AddonSerializerOutputTestMixin(object):
    ...
    def test_basic(self):
        ...
        assert result_preview['caption'] == {'en-US': u'My câption', 'fr': u'Mön tîtré'}
...
class TestESAddonSerializerOutput(AddonSerializerOutputTestMixin, ESTestCase):
    ...
    def serialize(self):
        self.serializer = self.serializer_class(
            context={'request': self.request, 'view': AddonSearchView(action='list')}
        )
...
class TestVersionSerializerOutput(TestCase):
    ...
    def test_basic(self):
        ...
        assert result['compatibility'] == {'firefox': {'max': u'*', 'min': u'50.0'}}
        ...
        assert result['files'][1]['url'] == second_file.get_absolute_url(src='')
    ...
    def test_basic(self):
        ...
        expected_data = {
            ...
            'current_version': {
                ...
                'compatibility': {'firefox': {'min': '4.0.99', 'max': '5.0.99',}},
