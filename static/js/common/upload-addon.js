    ...
    $.fn.addonUploader = function( options ) {
        ...
        return $(this).each(function(){
            ...
            var ui_parent = $('<div>', {'class': 'invisible-upload prominent cta', 'id': 'upload-file-widget'}),
                ...
                ui_details = $('<div>', {'class': 'upload-details', 'text': gettext('Your add-on should end with .zip, .xpi, .crx or .xml')});
                ...
                if (! results.validation) {
                    ...
                    if (messageCount > 0) {
                        ...
                        if (results.validation.metadata.contains_binary_extension) {
                            messages.push(gettext("Minified, concatenated or otherwise machine-generated scripts (excluding known libraries) need to have their sources submitted separately for review. Make sure that you use the source code upload field to avoid having your submission rejected."));
                        }
