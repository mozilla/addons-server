    ...
    def test_overview(self):
        ...
        while 1:
            if next_expected['date'] == next_actual['date']:
                ...
                assert next_actual['data'] == {'downloads': 0, 'updates': 0}
...
class TestSiteQuery(amo.tests.TestCase):
    ...
    def test_period(self):
        with pytest.raises(AssertionError):
            views._site_query('not_period', self.start, self.end)
...
class TestSite(amo.tests.TestCase):
    ...
    def tests_no_date(self, _site_query):
        ...
        assert _site_query.call_args[0][1] == datetime.date.today() - datetime.timedelta(days=365)
