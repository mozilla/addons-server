...
from apps.api.github import GithubCallback, GithubRequest, rezip_file
...
class TestGithub(TestCase):
    ...
    def test_github(self):
        ...
        assert (
            form.cleaned_data['comment_url'] ==
            'https://api.github.com/repos/org/repo/pulls/1/comments')
...
class GithubBase(TestCase):
    ...
    def setUp(self):
        ...
        patch = mock.patch('apps.api.github.requests', autospec=True)
        self.addCleanup(patch.stop)
        self.requests = patch.start()
        self.data = {
            'type': 'github',
            'status_url': 'https://github/status',
            'comment_url': 'https://github/comment',
...
class TestCallback(GithubBase):
    ...
    def test_comment(self):
        ...
        self.check_status(
            'comment', url=self.data['comment_url'], path='some/file', line=35)
