...
class TestHelpers(test.TestCase):
    ...
    def test_url(self, mock_reverse):
    ...
    def test_wround(self):
        # Invalid input formats.
        self.assertRaises(TypeError, wround, None)
        self.assertRaises(TypeError, wround, 'yadayada')
        self.assertRaises(TypeError, wround, '0')

        # Integers as well as floats should work.
        self.assertAlmostEqual(wround(5, 2), 5)
        self.assertAlmostEqual(wround(5.001, 2), 5)
