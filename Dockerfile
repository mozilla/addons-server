...
# In order to create js i18n files with all of our srtings,
# we need to include the compiled locale files
COPY --from=locales --chown=olympia:olympia locale/ ${HOME}/locale/
